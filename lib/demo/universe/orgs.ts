...
export const ORGS: UniverseOrg[] = [
  {
    ...
    os: 'shopos',
    osLabel: 'Business workspace',
    area: 'Big Qua Town',
    address: '14 Big Qua Town Line, Calabar',
    tagline: 'Fresh produce, weighed and priced in-app',
    desc: 'The anchor demo store. Farm-fresh produce, pantry staples and household essentials — weighed on the market floor and priced live in naira. CityDrive delivers around Calabar.',
    rating: 4.8,
    reviews: 641,
    emoji: '🧺',
  ...
  },
  {
    ...
    os: 'serviceos',
    osLabel: 'Service workspace',
    area: 'Ekorinim',
    address: '8 Ekorinim Road, Calabar',
    tagline: 'AC service, gas refills & installs',
    desc: 'The anchor demo business. Filter services, gas refills, new installs and window-unit pick-ups across Calabar metro — quoted before we touch the unit.',
    rating: 4.9,
    reviews: 276,
    emoji: '❄️',
  ...
  },
  {
    ...
    category: 'School',
    os: 'schoolos',
    osLabel: 'School workspace',
    area: 'Ikot Ansa',
    address: '5 Hope Avenue, Ikot Ansa, Calabar',
    tagline: 'Nursery to Senior Secondary',
    desc: 'The anchor demo school. Nursery through SSS, low student-teacher ratios and termly results published to parents through the work portal.',
    rating: 4.7,
    reviews: 98,
    emoji: '🎓',
...
export const EXPERIENCES: Experience[] = [
  { id: 'resident', label: 'City Resident', sub: 'Home, map, create & city services', emoji: '🏙️', href: '/' },
  {
    ...
    sub: 'Business operational workspace',
    emoji: '🧺',
    os: 'shopos',
    slug: 'freshmart-calabar',
  ...
  },
  {
    ...
    sub: 'Service operational workspace',
    emoji: '❄️',
    os: 'serviceos',
    slug: 'mikes-ac-services',
  ...
  },
  {
    ...
    sub: 'School operational workspace',
    emoji: '🎓',
    os: 'schoolos',
    slug: 'hope-academy',
