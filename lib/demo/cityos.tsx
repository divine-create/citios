...
export const DEMO_BUSINESSES: Business[] = [
  ...
  },
  {
    ...
    desc: 'Fresh produce across the city, weighed on the market floor and priced live in naira. CityDrive delivers around Calabar in under 25 minutes.',
    rating: 4.8,
    reviews: 641,
    isOpen: true,
    ...
    tags: ['CityMart', 'Big Qua Town', 'CityDrive 22 min'],
  },
  {
    slug: 'mamas-kitchen',
    ...
    tags: ['CityFood', 'Marian Road', 'Party Trays'],
  },
  {
    ...
    tags: ['CityMart', 'State Housing', 'Studio'],
  },
];
...
export const DEMO_SCHOOLS: DemoSchool[] = [
  ...
  },
  {
    ...
    desc: 'Nursery through SSS with low student-teacher ratios, termly results published to parents, and intake around the year.',
    rating: 4.7,
    image: 'https://images.unsplash.com/photo-1509062522246-3755977927d7?auto=format&fit=crop&w=1000&q=80',
...
export const DEMO_POSTS: FeedPost[] = [
  ...
  { id: 'f22', author: 'FreshMart Calabar', role: 'CityMart', avatarImg: 'https://images.unsplash.com/photo-1542838132-92c53300491e?auto=format&fit=crop&w=200&q=80', time: '1d ago', category: 'Commerce', title: 'Picker roles open', body: 'Market-floor pickers and packers needed at Big Qua Town. Full-time, ₦65,000/mo, picker bonus pool.', likes: 103, comments: 30, shares: 26, href: { label: 'Apply at CityJobs', url: '/jobs/j-sh-01' }, isOrg: true },
  ...
  { id: 'f37', author: 'FreshMart Calabar', role: 'CityMart', avatarImg: 'https://images.unsplash.com/photo-1542838132-92c53300491e?auto=format&fit=crop&w=200&q=80', time: '4d ago', category: 'Commerce', title: 'Ugu price dip', body: 'Early-morning waterleaf bundles dropped to ₦1,800. Whole week’s soup sorted for under two drinks.', likes: 141, comments: 17, shares: 9, href: { label: 'Shop FreshMart', url: '/biz/freshmart-calabar' }, isOrg: true },
  ...
  { id: 'f40', author: "Mike's AC Services", role: 'CityServices', avatarImg: 'https://images.unsplash.com/photo-1621905251189-08b45d6a269e?auto=format&fit=crop&w=200&q=80', time: '5d ago', category: 'Commerce', title: 'Technician hired + lessons', body: 'We hired through CityJobs and paid a signing bonus via CityPay. First week review: local and sharp.', likes: 58, comments: 9, shares: 6, href: { label: 'Service workspace', url: '/workspaces/serviceos/mikes-ac-services' }, isOrg: true },
