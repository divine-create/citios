        ...
        <div className="space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <select 
              ...
              onChange={(e: any) => setSettings({ ...settings, serviceStyle: e.target.value })}
            >
          ...
          <div className="pt-2 flex items-center justify-between p-4 bg-slate-50 rounded-xl border border-slate-100">
            ...
            <button 
              ...
              className={"w-12 h-6 rounded-full transition-colors relative " + (settings.acceptsWalkIns ? 'bg-emerald-500' : 'bg-slate-300')}
            >
              <div className={"w-4 h-4 bg-white rounded-full absolute top-1 transition-transform " + (settings.acceptsWalkIns ? 'translate-x-7' : 'translate-x-1')} />
            </button>
          </div>
        </div>
      </div>
