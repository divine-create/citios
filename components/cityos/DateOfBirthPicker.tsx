...
export default function DateOfBirthPicker({
  ...
  const update = (newY: string, newM: string, newD: string) => {
    if (newY && newM && newD) {
      ...
      // Partial selection keeps the existing string format
      ...
      <div className="grid grid-cols-3 gap-2 sm:gap-3">
        ...
        <div className="relative">
          <select
            ...
            className="w-full appearance-none pl-3 pr-7 py-3 rounded-xl bg-slate-50 border border-slate-200 text-xs sm:text-[13px] font-semibold text-slate-800 focus:outline-none focus:ring-2 focus:ring-teal-600 focus:bg-white transition-all cursor-pointer disabled:opacity-50"
          >
