  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans selection:bg-blue-200">
      ...
      <nav className="fixed top-0 w-full bg-white/80 backdrop-blur-md border-b border-slate-200 z-50">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-xl tracking-tight text-slate-900">CityOS <span className="text-blue-600">School</span></span>
          </div>
      ...
      <section className="pt-32 pb-20 px-6 overflow-hidden relative">
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <h1 className="text-5xl md:text-7xl font-black text-slate-900 tracking-tight leading-[1.1] mb-6 animate-in fade-in slide-in-from-bottom-6 duration-700 delay-100">
            The Complete Operating System <br className="hidden lg:block"/> for Modern Schools.
          </h1>
      ...
      <section id="features" className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl md:text-5xl font-bold text-slate-900 tracking-tight mb-4">Everything your school needs, <br/><span className="text-blue-600">out of the box.</span></h2>
            <p className="text-lg text-slate-500">Stop juggling multiple software subscriptions. SchoolOS provides native, interconnected modules for every department.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              { icon: Globe, color: "text-pink-600", bg: "bg-pink-50", title: "Microsite Builder", desc: "Generate a beautiful, public-facing school website with drag-and-drop themes in seconds." },
              { icon: CalendarDays, color: "text-indigo-600", bg: "bg-indigo-50", title: "Attendance & Events", desc: "Track daily roll calls, sync school holidays, and organize PTA meetings on a global calendar." }
            ].map((feature, idx) => (
      ...
      <footer className="bg-slate-50 py-12 border-t border-slate-200 text-center text-slate-500 text-sm">
        <p>© {new Date().getFullYear()} CityConnect SchoolOS. All rights reserved.</p>
      </footer>
    </div>
  );
}
